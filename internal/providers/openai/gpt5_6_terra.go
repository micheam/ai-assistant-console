...
var (
	_ assistant.GenerativeModel         = (*GPT56Terra)(nil)
	_ assistant.GenerationOptionCapable = (*GPT56Terra)(nil)
)
...
func (m *GPT56Terra) SetGenerationOptions(opts assistant.GenerationOptions) {
	m.genOpts = opts
}
