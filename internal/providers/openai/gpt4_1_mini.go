...
var (
	_ assistant.GenerativeModel         = (*GPT41Mini)(nil)
	_ assistant.GenerationOptionCapable = (*GPT41Mini)(nil)
)
...
func (m *GPT41Mini) SetGenerationOptions(opts assistant.GenerationOptions) {
	m.genOpts = opts
}
